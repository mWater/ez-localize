...
function findInJs(js) {
    ...
    walk.simple(acorn.parse(js, { ecmaVersion: "latest" }), {
        CallExpression: function (node) {
            ...
            else if (((_d = node.callee) === null || _d === void 0 ? void 0 : _d.name) === "T" && ((_e = node.arguments[0]) === null || _e === void 0 ? void 0 : _e.type) === "ObjectExpression") {
                const textProperty = node.arguments[0].properties.find((prop) => prop.key.name === 'text');
                if (textProperty && textProperty.value.type === 'Literal') {
                    items.push(textProperty.value.value);
                }
            }
            else if (((_g = (_f = node.callee) === null || _f === void 0 ? void 0 : _f.property) === null || _g === void 0 ? void 0 : _g.name) === "T" && typeof ((_h = node.arguments[0]) === null || _h === void 0 ? void 0 : _h.value) === "string") {
                items.push((_j = node.arguments[0]) === null || _j === void 0 ? void 0 : _j.value);
            }
            else if (((_l = (_k = node.callee) === null || _k === void 0 ? void 0 : _k.property) === null || _l === void 0 ? void 0 : _l.name) === "T" && ((_m = node.arguments[0]) === null || _m === void 0 ? void 0 : _m.type) === "ObjectExpression") {
                const textProperty = node.arguments[0].properties.find((prop) => prop.key.name === 'text');
                if (textProperty && textProperty.value.type === 'Literal') {
                    items.push(textProperty.value.value);
                }
