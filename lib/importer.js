...
var _, fs, importXlsx, updateLocalizedStrings;

fs = require('fs');
_ = require('lodash');
importXlsx = require('./utils').importXlsx;
updateLocalizedStrings = require('./utils').updateLocalizedStrings; // oldDataFile: e.g. "localizations.json"
...
module.exports = function (oldDataFile, xlsxFile, newDataFile) {
  var base64File, localizations, updates; // Read the xlsx file and get the locales
  ...
  updateLocalizedStrings(localizations.strings, updates); // Sort by used
