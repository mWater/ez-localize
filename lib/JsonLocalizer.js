...
/*
Extracts localized strings out of a plain javascript object
Removes duplicates
Exports/imports to xlsx
 */

module.exports = Localizer = (function() {
  function Localizer() {}

  Localizer.prototype.extractLocalizedStrings = function(obj) {
  ...
  Localizer.prototype.dedupLocalizedStrings = function(strs) {
  ...
  Localizer.prototype.changeBaseLocale = function(strs, fromLocale, toLocale) {
  ...
  Localizer.prototype.exportXlsx = function(locales, strs) {
  ...
  Localizer.prototype.importXlsx = function(locales, xlsxFile) {
  ...
  Localizer.prototype.updateLocalizedStrings = function(strs, updates) {
