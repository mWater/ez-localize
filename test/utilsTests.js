...
describe("Localizer", function() {
  ...
  describe("dedupLocalizedStrings", () => it("removes duplicates by base + string", function() {
    const strs = [
  ...
  describe("changeBaseLocale", () => it("changes base, preserving other strings but overwriting with base", function() {
    const strs = [
      { _base: "en", en: "hello", es: "esp1" },
  ...
  describe("xlsx export/import", function() {
    beforeEach(function() {
      ...
      this.locales = [{code: "en", name: "English"}, {code: "es", name: "Espanol"}];
