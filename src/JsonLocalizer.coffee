...
module.exports = class Localizer
  ...
  changeBaseLocale: (strs, fromLocale, toLocale) ->
    for str in strs
      # Get displayed 
      if str[fromLocale]
  ...
  updateLocalizedStrings: (strs, updates) ->
