...
/** Localize json object */
export default class JsonLocalizer {
  /** Extracts localized strings from a plain object */
  extractLocalizedStrings(obj: any): LocalizedString[]

  /** Keep unique base language string combinations */
  dedupLocalizedStrings(strs: LocalizedString[]): LocalizedString[]

  /** Change the base locale for a set of localizations. 
   * Works by making whatever the user sees as the toLocale base 
   */
  changeBaseLocale(strs: LocalizedString[], fromLocale: string, toLocale: string): void

  /** Exports localized strings for specified locales to XLSX file. Returns base64 */
  exportXlsx(locales: Locale[], strs: LocalizedString[]): string 

  /** Import from base64 excel */
  importXlsx(locales: Locale[], xlsxFile: string): LocalizedString[]

  /** Update a set of strings based on newly localized ones */
  updateLocalizedStrings(strs: LocalizedString[], updates: LocalizedString[]): void
}